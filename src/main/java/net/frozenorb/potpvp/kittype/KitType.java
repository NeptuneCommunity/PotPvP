...
public final class KitType {
    ...
    static {
        ...
        collection.find().iterator().forEachRemaining(doc -> allTypes.add(PotPvPSI.plainGson.fromJson(doc.toJson(), KitType.class)));
        ...
        if (byId("NODEBUFF") == null) { // has too be all upper case
            ...
            kitType.setDisplayName("NoDebuff"); // the name used in game for queues and stuff
