...
public final class PlayerUtils {
    ...
    public static void animateDeath(Player player, Player watcher) {
        ...
        try {
            ...
            Bukkit.getScheduler().runTaskLater(PotPvPSI.getInstance(), () -> ((CraftPlayer) watcher).getHandle().playerConnection.sendPacket(new PacketPlayOutEntityDestroy(entityId)), 40L);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
